...
- 复制：支持将支出/收入/转账流水复制到右侧对应录入表单，并自动切换到对应 tab，用户确认后可直接保存
- 删除：删除一条流水
- 退款：
...
- 行程规划：`/tools/travel-planner`
  ...
  - 编辑输入框支持按 `Tab` 快速补全固定通勤内容：上午为“上班 6:39”，下午为“回家 19:15”
  - 操作栏右侧显示当前月通勤次数统计：上午、下午各记一次
...
- pages/
  ...
  - stats/：统计页面与工具
    ...
    - YoYStatsPage.tsx：同比
    - CategoryMonthlyLinePage.tsx：月度收支分析
